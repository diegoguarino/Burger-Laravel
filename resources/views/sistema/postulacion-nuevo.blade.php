...
<div class="panel-body">
      ...
      <div class="form-group col-6">
                  ...
                  <input type="text" id="txApellido" name="txtApellido" class="form-control" value="{{$postulacion->apellido}}" required>
      </div>
            <div class="form-group col-6">
                  <label>Whatsapp: *</label>
                  <input type="number" id="txtWhatsapp" name="txtWhatsapp" class="form-control" value="{{$postulacion->whatsapp}}" required>
      </div>
            <div class="form-group col-6">
                  <label>Correo: *</label>
