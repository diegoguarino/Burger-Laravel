...

{
      ...
      public function guardar(Request $request)
      {
            ...
            return view('sistema.pedido-nuevo', compact("titulo", "aClientes", "aSucursales", "aEstadoPedidos", "pedido")) . '?id=' . $pedido->idpedido;
      }
      ...
      public function editar($idPedido)
      {
            ...
            if (Usuario::autenticado() == true) {
                  if (!Patente::autorizarOperacion("CLIENTEEDITAR")) {
                        ...
                        return view("sistema.pedido-nuevo", compact("titulo", "pedido", "aSucursales", "aClientes", "aEstadoPedidos", "aPedidoProductos"));
                  }
            } else {
                  return redirect('admin/login');
            }
